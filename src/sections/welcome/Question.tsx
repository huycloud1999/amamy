...
const Question = () => {
  return (
    <div className="w-full h-full bg-white flex justify-center items-center font-montserrat pt-[47px] xsm:pt-[30px] pb-[67px] xsm:pb-[35px]">
      <div className="w-[1299px] xsm:w-full">
        ...
        <div className="grid grid-cols-12 xsm:grid-cols-1 gap-x-[28px]">
          <Accordion
            ...
            className="col-span-8 xsm:col-span-1 flex flex-col gap-[20px] xsm:gap-[12px] xsm:px-[33px]"
          >
            {faqs?.map((faq, index) => (
              <AccordionItem
                key={index}
              ...
              >
                <AccordionTrigger
                  ...
                  icon={
                    <svg className="text-[#38B6FF] group-data-[state=open]:text-[#cccccc]" width="34" height="34" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                >
                  <span className="font-semibold xsm:font-medium text-[18px] xsm:text-[14px] leading-[28px] tracking-normal">{faq.question}</span>
                </AccordionTrigger>
          ...
          <div className="xsm:hidden col-span-4 xsm:col-span-1 flex flex-col gap-[20px]">
            <div className='flex flex-col rounded-[24px] bg-[#F4FBFF] gap-[20px] px-[38px] pt-[46px] pb-[30px]'>
              {
                shippingRoutes.map((route, i) => (
                  <div key={i} className='flex justify-between items-center pb-[18px] border-b border-[#E3DBD8] hover:text-Blue-Primary'>
                    <span className='font-medium text-[24px] leading-[100%] tracking-normal'>
                      {route.route}
                    </span>
                    <svg width="8" height="11" viewBox="0 0 8 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M1.75 11C1.50391 11 1.28516 10.918 1.12109 10.7539C0.765625 10.4258 0.765625 9.85156 1.12109 9.52344L4.86719 5.75L1.12109 2.00391C0.765625 1.67578 0.765625 1.10156 1.12109 0.773438C1.44922 0.417969 2.02344 0.417969 2.35156 0.773438L6.72656 5.14844C7.08203 5.47656 7.08203 6.05078 6.72656 6.37891L2.35156 10.7539C2.1875 10.918 1.96875 11 1.75 11Z" fill="black" />
                    </svg>
                  </div>
                ))
              }
          ...
          {/* MB */}
          <div className='hidden xsm:flex col-span-1 flex-col gap-[24px] px-[18px] mt-[35px] w-full'>
